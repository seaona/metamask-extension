 ...
 */
 ...
 // import { wakuReadMessages } from '../../ui/pages/chat/chat.utils';
   ...
   setTimeout(async () => {
     await browser.notifications
       .create({
         ...
         message: 'Somebody has just messaged you',
       })
       .catch((e) => console.log('error in displaying notification', e));
   }, 20000);
 }
 ...
 // Chat notifications on the background
 browser.runtime.onConnect.addListener(() => {
   console.log('staring chat listener....');
   startChatListener();
 });